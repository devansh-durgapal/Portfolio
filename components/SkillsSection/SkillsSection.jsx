...
const skills = [
  ...
  },
  {
    name: 'Next.js',
    color: '#EEEEEE',
    desc: 'React framework for production — SSR, App Router, and edge deployment.',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="36" height="36">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.52 2 12 2zm-1 14.5v-9l7 4.5-7 4.5z"/>
      </svg>
    ),
  },
  {
    name: 'Three.js',
    color: '#049EF4',
    desc: '3D WebGL library for cinematic visuals, particle systems, and 3D scenes.',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="36" height="36">
